...
def main():
    ...
    parser.add_argument('-i', '--input_path', default='C:\\Users\\guill\\OneDrive - Universite de Montreal\\HIV 2025\\Projets en apprentissage automatique\\IFT3710-Advanced-Project-in-ML-AI\\data\\Tuning', type=str, help='training data path; subfolders: images, labels')
    parser.add_argument("-o", '--output_path', default='C:\\Users\\guill\\OneDrive - Universite de Montreal\\HIV 2025\\Projets en apprentissage automatique\\IFT3710-Advanced-Project-in-ML-AI\\data\\Tuning_Pre_3class', type=str, help='preprocess data path')
